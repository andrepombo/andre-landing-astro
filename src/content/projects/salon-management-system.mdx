...
description: Full-stack salon management system that lets beauty salons manage clients, staff, services, and appointments in one place, with a modern React dashboard talking to a Django REST API.
...
A full-stack salon management system that centralizes daily operations for beauty salons.
